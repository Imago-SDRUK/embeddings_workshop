...
def make_webmap_general(
    ...
    ------
    ValueError
        If `focus_gdf` is empty, `focus_col` is missing, or `fit_to` is invalid.
    """
    ...
    bounds_gdf = context_wgs84 if fit_to == "all" and context_wgs84 is not None and len(context_wgs84) > 0 else focus_wgs84
